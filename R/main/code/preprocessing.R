...
head(exportDF)
library(openxlsx)
write.xlsx(exportDF, sheetName = "sheet1", file = "./export/FA_RESULT.xlsx")
...
export_PCA_DF <- data.frame(human_PC1, human_PC2, anim_PC1, anim_PC2, anim_PC3, anim_PC4, infra,
...
head(export_PCA_DF)
library(openxlsx)
write.xlsx(export_PCA_DF, sheetName = "sheet1", file = "./export/PCA_RESULT.xlsx")
